...
??_lcd_data:	; 1 bytes @ 0x0
	ds   1
	global	lcd_cmd@cmdout
lcd_cmd@cmdout:	; 1 bytes @ 0x1
...
;; Auto vars:     Size  Location     Type
;;  cmdout          1    1[COMRAM] unsigned char 
;; Return value:  Size  Location     Type
;;                  1    wreg      void 
;; Registers used:
;;		wreg, status,2, cstack
...
;incstack = 0
	callstack 29
	movwf	((c:lcd_cmd@cmdout))^00h,c
	line	67
	
l817:
	movff	(c:lcd_cmd@cmdout),(c:3978)	;volatile
	line	68
...
l829:
	movff	(c:lcd_data@data),(c:3978)	;volatile
	line	79
...
asmopt off
movlw	26
movwf	(??_lcd_data+0+0)^00h,c
	movlw	248
u47:
decfsz	wreg,f
	bra	u47
	decfsz	(??_lcd_data+0+0)^00h,c,f
	bra	u47
	nop2
asmopt pop
